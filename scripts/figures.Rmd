...
plot_grid(lofreq.roc.p, tbl, labels=c("A", "B"), ncol = 1, nrow = 2)


pdf("../results/figures/lofreq1.pdf",width=7,height=2.5)
plot_grid(lofreq.roc.p, tbl, labels=c("A", "B"), ncol = 2, nrow = 1)
dev.off()
